---
title: Glass Stops and Adapters
sidebar_position: 11
---
...
<div class="app-img"><img src="/screenshots/sao-tab.png"/></div>
...
<div class="app-img"><img src="/screenshots/sao-tab-2-shaded.png"/></div>

#### Adding a new assembly 
After adding an assembly if you want to edit it further that can be done in the **Components** tab.
<div class="app-img"><img src="/screenshots/sao-tab-3.png"/></div>

[Click here](/docs/v16/jobs/tool-tabs/stopadapter) to learn about using the Stop/Adapter tool tab.
