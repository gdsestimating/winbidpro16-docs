...
:::warning
    The WinBidPro v16 Docs are currently being updated. Some pages may be placeholder for now, but check back soon!

    * If you need extra information on a specific topic, see our [Training Videos](https://www.gdsestimating.com/v16-training-videos) page. 
    
    * If you still can't find what you need, feel free to reach out to [Support](https://www.gdsestimating.com/support) with any questions.
:::

---

:::info 
    This section is an introduction to WinBidPro v16. It covers first steps, basic workflow for all jobs, and the interface.
:::
...
<div class="app-img"><img src="/screenshots/interface/welcome.png"/></div>
...
<div class="app-img"><img src="/screenshots/components-tab.png"/></div>
...
<div class="app-img"><img src="/screenshots/new-job-window.png"/></div>
...
<div class="app-img"><img src="/screenshots/layout-tab-new.png"/></div>
...
For a more indepth breakdown of how to build elevations and all the available drawing tools check out the [Jobs Section](/docs/v16/jobs/elevations).