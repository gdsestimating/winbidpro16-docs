...
![Compact and Repair Vendor](/screenshots/compact-repair-vendor.png)
...
![Vendor Database File Location](/screenshots/vendordb-location.png)
...
![Navigate to Vendor Folder in Explorer](/screenshots/find-vendor-file.png)

### Zip the folder

Go up one level so you can see the vendor folder itself. Right-click it and choose **Send to → Compressed (zipped) folder**.

![Zip the Vendor Folder](/screenshots/zip-vendors.png)
