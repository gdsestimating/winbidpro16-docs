...
To navigate to the job alerts view click the **Job Alert Status** icon beneath the elevation tool tabs.

![](/screenshots/job-alert-status.png)
Or from the `Job` Menu.

![jobalertmenu](/screenshots/job-alert-menu.png)

## Column Head Definitions

**Code**: The unique identifier for this type of alert.<br/>
**Elevation**: The name of the elevation that the alert occurred in. If this is blank than the error is for a conflicting system setting.<br/>
